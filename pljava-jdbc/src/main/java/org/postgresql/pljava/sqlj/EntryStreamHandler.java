...
class EntryStreamHandler extends URLStreamHandler {
    class EntryConnection extends URLConnection {
        ...
        /**
         * Executes the prepared statement that will fetch an image based on the
         * entryId denoted by the URL of this connection. If connect has been
         * called already, subsequent calls are ignored.
         */
        @Override
        public void connect() throws IOException {
            ...
            try {
                ...
                stmt = SQLUtils.getDefaultConnection().prepareStatement("SELECT entryName, entryImage FROM sqlj.jar_entry WHERE entryId = ?");
        ...
        /**
         * Consults the current {@link java.net.FileNameMap FileNameMap} to
         * obtain the MIME type for the file name extension for the entry
