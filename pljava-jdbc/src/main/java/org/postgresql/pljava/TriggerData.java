...
/**
 * The SQL 2003 spec. does not stipulate a standard way of mapping triggers to
 * functions. The PLJava mapping use this interface. All functions that are
 * intended to be triggers must be public, static, return void, and take a
 * <code>TriggerData</code> as their argument.
 * 
...
public interface TriggerData {
     ...
     * The returned set will be updateable and positioned on a valid row. When
     * the trigger call returns, the trigger manager will see the changes that
     * has been made to this row and construct a new tuple which will become the
     * new or updated row.
     * 
    ...
    /**
     * Returns the name of the schema of the table for which this trigger was
     * created (as declared in the <code>CREATE TRIGGER</code statement).
     * 
     * @throws SQLException
     *             if the contained native buffer has gone stale.
     */
