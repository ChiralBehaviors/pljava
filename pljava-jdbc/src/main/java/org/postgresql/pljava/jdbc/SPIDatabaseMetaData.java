...
public class SPIDatabaseMetaData implements DatabaseMetaData {
     ...
     * <LI><B>SCOPE_CATALOG</B> String => catalog of table that is the scope of
    ...
    public java.sql.ResultSet getBestRowIdentifier(String catalog,
        ...
        ArrayList<Object[]> v = new ArrayList<Object[]>(); // The new ResultSet tuple stuff
        ...
        while (rs.next()) {
            ...
            tuple[6] = null;
            tuple[7] = new Short(
                                 (short) java.sql.DatabaseMetaData.bestRowNotPseudo);
            v.add(tuple);
        }
    ...
    public java.sql.ResultSet getColumnPrivileges(String catalog,
        ...
        while (rs.next()) {
            ...
            for (String permName : permNames) {
                ArrayList<?> grantees = permissions.get(permName);
    ...
    public java.sql.ResultSet getColumns(String catalog, String schemaPattern,
        ...
        while (rs.next()) {
            ...
            if (pgType.equals("bpchar") || pgType.equals("varchar")) {
                ...
                tuple[6] = new Integer(atttypmod != -1 ? atttypmod - VARHDRSZ
                                                      : 0);
    ...
    public java.sql.ResultSet getProcedureColumns(String catalog,
        ...
        while (rs.next()) {
            ...
            if (!returnTypeType.equals("c")) {
                ...
                tuple[5] = new Short(
                                     (short) m_connection.getSQLType(returnType));
            ...
            if (returnTypeType.equals("c")) {
                ...
                while (columnrs.next()) {
                    ...
                    tuple[5] = new Short(
                                         (short) m_connection.getSQLType(columnTypeOid));
    ...
    public RowIdLifetime getRowIdLifetime() throws SQLException {
        throw new SQLFeatureNotSupportedException(
                                                  "SPIDatabaseMetadata.getRowIdLifetime() not implemented yet.",
                                                  "0A000");
    ...
    public String getStringFunctions() throws SQLException {
        String funcs = BuiltinFunctions.ASCII + ',' + BuiltinFunctions.CHAR
                       ...
                       + BuiltinFunctions.LCASE + ',' + BuiltinFunctions.LEFT
                       + ',' + BuiltinFunctions.LENGTH + ','
                       + BuiltinFunctions.LTRIM + ',' + BuiltinFunctions.REPEAT
                       + ',' + BuiltinFunctions.RTRIM + ','
                       + BuiltinFunctions.SPACE + ','
    ...
    public java.sql.ResultSet getTables(String catalog, String schemaPattern,
        ...
        String select = "SELECT NULL AS TABLE_CAT, n.nspname AS TABLE_SCHEM, c.relname AS TABLE_NAME, "
                        ...
                        + " WHERE c.relnamespace = n.oid "
                        + " AND "
                        + resolveSchemaPatternCondition("n.nspname",
                                                        schemaPattern);
        ...
        for (String type : types) {
            HashMap<?, ?> clauses = s_tableTypeClauses.get(type);
            if (clauses != null) {
    ...
    public java.sql.ResultSet getVersionColumns(String catalog, String schema,
        ...
        tuple[6] = null;
        tuple[7] = new Short(
                             (short) java.sql.DatabaseMetaData.versionColumnPseudo);
        v.add(tuple);
    ...
    public boolean supportsSavepoints() throws SQLException {
        return getDatabaseMajorVersion() >= 8;
    }
    ...
    /**
     * Add the user described by the given acl to the ArrayLists of users with
     * the privileges described by the acl.
     */
    private void addACLPrivileges(String acl,
        ...
        for (int i = 0; i < privs.length(); i++) {
            ...
            ArrayList<String> usersWithPermission = privileges.get(sqlpriv);
    ...
    protected java.sql.ResultSet getImportedExportedKeys(String primaryCatalog,
        ...
        String sql = "SELECT NULL::text AS PKTABLE_CAT, pkn.nspname AS PKTABLE_SCHEM, pkc.relname AS PKTABLE_NAME, pka.attname AS PKCOLUMN_NAME, "
                     ...
                     + " AND "
                     + resolveSchemaCondition("fkn.nspname", foreignSchema);
