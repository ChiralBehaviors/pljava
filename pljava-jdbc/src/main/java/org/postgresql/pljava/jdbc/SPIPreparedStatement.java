...
public class SPIPreparedStatement extends SPIStatement implements
    ...
    public void addBatch() throws SQLException {
        internalAddBatch(new Object[] { m_values.clone(), m_sqlTypes.clone(),
                m_typeIds.clone() });
    ...
    public void addBatch(String statement) throws SQLException {
        throw new UnsupportedFeatureException(
                                              "Can't add batch statements to a prepared statement");
    }
    ...
    public boolean execute(String statement) throws SQLException {
        throw new UnsupportedFeatureException(
                                              "Can't execute other statements using a prepared statement");
    }
     ...
     * {@link Types#VARCHAR}. Once the parameters have been set, a fair attempt
     * is made to generate this object based on the supplied values.
     * 
    ...
    public void setAsciiStream(int columnIndex, InputStream value, int length)
        ...
        try {
            this.setObject(columnIndex,
                           new ClobValue(new InputStreamReader(value,
                                                               "US-ASCII"),
                                         length), Types.CLOB);
    ...
    public void setBoolean(int columnIndex, boolean value) throws SQLException {
        this.setObject(columnIndex, value ? Boolean.TRUE : Boolean.FALSE,
                       Types.BOOLEAN);
    }
    ...
    public void setCharacterStream(int parameterIndex, Reader reader,
                                   long lenght) throws SQLException {
        throw new SQLFeatureNotSupportedException(
                                                  this.getClass()
    ...
    public void setObject(int columnIndex, Object value) throws SQLException {
        ...
        this.setObject(columnIndex, value,
                       SPIConnection.getTypeForClass(value.getClass()));
    }
    ...
    public void setObject(int columnIndex, Object value, int sqlType)
        ...
        Oid id = sqlType == Types.OTHER ? Oid.forJavaClass(value.getClass())
    ...
    protected int executeBatchEntry(Object batchEntry) throws SQLException {
        ...
        for (int i = 0; i < m_typeIds.length; i++) {
            if (m_typeIds[i] != batchTypeIds[i]) {
                ...
                System.arraycopy(batchTypeIds, 0, m_typeIds, 0,
                                 m_typeIds.length);
                break;
            }
        }
