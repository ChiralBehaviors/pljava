...
public abstract class AbstractResultSet implements ResultSet {
    public Array getArray(String columnName) throws SQLException {
        return this.getArray(findColumn(columnName));
    }

    public InputStream getAsciiStream(String columnName) throws SQLException {
        return this.getAsciiStream(findColumn(columnName));
    }

    public BigDecimal getBigDecimal(String columnName) throws SQLException {
        return this.getBigDecimal(findColumn(columnName));
    }
    ...
    public BigDecimal getBigDecimal(String columnName, int scale)
                                                                 throws SQLException {
        return this.getBigDecimal(findColumn(columnName), scale);
    }

    public InputStream getBinaryStream(String columnName) throws SQLException {
        return this.getBinaryStream(findColumn(columnName));
    }

    public Blob getBlob(String columnName) throws SQLException {
        return this.getBlob(findColumn(columnName));
    }

    public boolean getBoolean(String columnName) throws SQLException {
        return this.getBoolean(findColumn(columnName));
    }

    public byte getByte(String columnName) throws SQLException {
        return this.getByte(findColumn(columnName));
    }

    public byte[] getBytes(String columnName) throws SQLException {
        return this.getBytes(findColumn(columnName));
    }

    public Reader getCharacterStream(String columnName) throws SQLException {
        return this.getCharacterStream(findColumn(columnName));
    }

    public Clob getClob(String columnName) throws SQLException {
        return this.getClob(findColumn(columnName));
    }
    ...
    public float getFloat(String columnName) throws SQLException {
        return this.getFloat(findColumn(columnName));
    }
    ...
    public NClob getNClob(int columnIndex) throws SQLException {
        throw new SQLFeatureNotSupportedException(
                                                  this.getClass()
                                                          + ".getNClob( int ) not implemented yet.",
                                                  "0A000");
    }
    ...
    public NClob getNClob(String columnLabel) throws SQLException {
        throw new SQLFeatureNotSupportedException(
                                                  this.getClass()
                                                          + ".getNClob( String ) not implemented yet.",
                                                  "0A000");
    }
    ...
    public String getNString(int columnIndex) throws SQLException {
        throw new SQLFeatureNotSupportedException(
                                                  this.getClass()
                                                          + ".getNString( int ) not implemented yet.",
                                                  "0A000");
    }
    ...
    public Object getObject(String columnName) throws SQLException {
        return this.getObject(findColumn(columnName));
    }

    public Object getObject(String columnName, Map<String, Class<?>> map)
                                                                         throws SQLException {
        return this.getObject(findColumn(columnName), map);
    }

    public Ref getRef(String columnName) throws SQLException {
        return this.getRef(findColumn(columnName));
    }

    public RowId getRowId(int columnIndex) throws SQLException {
        throw new SQLFeatureNotSupportedException(
                                                  this.getClass()
                                                          + "getRowId( int ) not implemented yet.",
                                                  "0A000");
    }
    ...
    public RowId getRowId(String columnLabel) throws SQLException {
        throw new SQLFeatureNotSupportedException(
                                                  this.getClass()
                                                          + ".getRowId( String ) not implemented yet.",
                                                  "0A000");
    }

    public short getShort(String columnName) throws SQLException {
        return this.getShort(findColumn(columnName));
    }

    public SQLXML getSQLXML(int columnIndex) throws SQLException {
        throw new SQLFeatureNotSupportedException(
                                                  this.getClass()
                                                          + ".getSQLXML( int ) not implemented yet.",
                                                  "0A000");
    }
    ...
    public SQLXML getSQLXML(String columnLabel) throws SQLException {
        throw new SQLFeatureNotSupportedException(
                                                  this.getClass()
                                                          + ".getSQLXML( String ) not implemented yet.",
                                                  "0A000");
    }
    ...
    public Time getTime(String columnName) throws SQLException {
        return this.getTime(findColumn(columnName));
    }

    public Time getTime(String columnName, Calendar cal) throws SQLException {
        return this.getTime(findColumn(columnName), cal);
    }

    public Timestamp getTimestamp(String columnName) throws SQLException {
        return this.getTimestamp(findColumn(columnName));
    }

    public Timestamp getTimestamp(String columnName, Calendar cal)
                                                                  throws SQLException {
        return this.getTimestamp(findColumn(columnName), cal);
    }
    ...
    public InputStream getUnicodeStream(String columnName) throws SQLException {
        return this.getUnicodeStream(findColumn(columnName));
    }

    public URL getURL(String columnName) throws SQLException {
        return this.getURL(findColumn(columnName));
    }
    ...
    public void updateArray(String columnName, Array x) throws SQLException {
        this.updateArray(findColumn(columnName), x);
    }
    ...
    public void updateBlob(String columnName, Blob x) throws SQLException {
        this.updateBlob(findColumn(columnName), x);
    }
    ...
    public void updateCharacterStream(String columnName, Reader x, int length)
                                                                              throws SQLException {
        this.updateCharacterStream(findColumn(columnName), x, length);
    }
    ...
    public void updateClob(String columnName, Clob x) throws SQLException {
        this.updateClob(findColumn(columnName), x);
    }
    ...
    public void updateRef(String columnName, Ref x) throws SQLException {
        this.updateRef(findColumn(columnName), x);
    }
