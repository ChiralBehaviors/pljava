...
public class SPIResultSetMetaData extends AbstractResultSetMetaData {
    ...
    public final String getColumnClassName(int column) throws SQLException {
        ...
        return getOid(column).getJavaClass().getName();
    }
    ...
    /**
     * Gets column length. This method is called if the AbstractResultSet does
     * not know how to get column length according to type OID. We retutn 0
     * because we don't know the proper length either.
     * 
     * @param column
     *            Column index
