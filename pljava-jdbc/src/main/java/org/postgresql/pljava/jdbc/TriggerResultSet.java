...
public class TriggerResultSet extends SingleRowResultSet {
    ...
    /**
     * Return a 2 element array describing the changes that has been made to the
     * contained Tuple. The first element is an <code>int[]</code> containing
     * the index of each changed value. The second element is an <code>Object[]
     * </code> with containing the corresponding values.
     * 
     * @return The 2 element array or <code>null</code> if no change has been
     *         made.
     */
    ...
    public void updateObject(int columnIndex, Object x) throws SQLException {
        ...
        if (m_tupleChanges == null) {
            m_tupleChanges = new ArrayList<Object>();
        }
    ...
    protected Object getObjectValue(int columnIndex) throws SQLException {
        ...
        return m_tuple.getObject(getTupleDesc(), columnIndex);
    }
