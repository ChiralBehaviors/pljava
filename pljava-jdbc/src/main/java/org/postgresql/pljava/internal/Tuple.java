...
public class Tuple extends JavaWrapper {
     ...
     * 
     * @param tupleDesc
     *            The Tuple descriptor for this instance.
     * @param index
     ...
     */
    public Object getObject(TupleDesc tupleDesc, int index) throws SQLException {
        synchronized (Backend.THREADLOCK) {
            return _getObject(getNativePointer(), tupleDesc.getNativePointer(),
                              index);
        }
    }
