...
public interface PooledObject {
     ...
     * 
     * @throws SQLException
     *             if something goes wrong with the activation. When this
     *             happens, a call will be issued to {@link #remove()} and the
     *             object will no longer be part of the pool.
     */
     ...
     * 
     * @throws SQLException
     *             if something goes wrong with the passivation. When this
     *             happens, a call will be issued to {@link #remove()} and the
     *             object will no longer be part of the pool.
     */
