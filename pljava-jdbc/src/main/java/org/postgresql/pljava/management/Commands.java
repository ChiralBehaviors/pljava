...
/**
 * This methods of this class are implementations of SQLJ commands. <h1>SQLJ
 * functions</h1> <h2>install_jar</h2> The install_jar command loads a jar file
 * from a location appointed by an URL or a binary image that constitutes the
 * contents of a jar file into the SQLJ jar repository. It is an error if a jar
 * with the given name already exists in the repository. <h3>Usage 1</h3>
 * <blockquote>
 * <code>SELECT sqlj.install_jar(&lt;jar_url&gt;, &lt;jar_name&gt;, &lt;deploy&gt;);</code>
 * </blockquote> <h3>Parameters</h3> <blockquote>
 * <table>
 * <tr>
 ...
 * <td>True if the jar should be deployed according to a
 * {@link org.postgresql.pljava.management.SQLDeploymentDescriptor deployment
 * descriptor}, false otherwise</td>
 * </tr>
 * </table>
 * </blockquote> <h3>Usage 2</h3> <blockquote>
 * <code>SELECT sqlj.install_jar(&lt;jar_image&gt;, &lt;jar_name&gt;, &lt;deploy&gt;);</code>
 * </blockquote> <h3>Parameters</h3> <blockquote>
 * <table>
 * <tr>
 ...
 * </tr>
 * </table>
 * </blockquote> <h2>replace_jar</h2> The replace_jar will replace a loaded jar
 * with another jar. Use this command to update already loaded files. It's an
 * error if the jar is not found. <h3>Usage 1</h3> <blockquote>
 * <code>SELECT sqlj.replace_jar(&lt;jar_url&gt;, &lt;jar_name&gt;, &lt;redeploy&gt;);</code>
 * </blockquote> <h3>Parameters</h3> <blockquote>
 * <table>
 * <tr>
 * <td valign="top"><b>jar_url</b></td>
 ...
 * </table>
 * </blockquote> <h3>Usage 2</h3> <blockquote>
 * <code>SELECT sqlj.replace_jar(&lt;jar_image&gt;, &lt;jar_name&gt;, &lt;redeploy&gt;);</code>
 * </blockquote> <h3>Parameters</h3> <blockquote>
 * <table>
 * <tr>
 * <td valign="top"><b>jar_image</b></td>
 ...
 * </tr>
 * </table>
 * </blockquote> <h2>remove_jar</h2> The remove_jar will drop the jar from the
 * jar repository. Any classpath that references this jar will be updated
 * accordingly. It's an error if the jar is not found. <h3>Usage</h3>
 * <blockquote>
 * <code>SELECT sqlj.remove_jar(&lt;jar_name&gt;, &lt;undeploy&gt;);</code>
 * </blockquote> <h3>Parameters</h3> <blockquote>
 * <table>
 * <tr>
 * <td valign="top"><b>jar_name</b></td>
 ...
 * <td>True if the jar should be undeployed according to its
 * {@link org.postgresql.pljava.management.SQLDeploymentDescriptor deployment
 * descriptor}, false otherwise</td>
 * </tr>
 * </table>
 * </blockquote> <h2>get_classpath</h2> The get_classpath will return the
 * classpath that has been defined for the given schema or NULL if the schema
 * has no classpath. It's an error if the given schema does not exist. <h3>Usage
 * </h3> <blockquote><code>SELECT sqlj.get_classpath(&lt;schema&gt;);</code>
 * </blockquote> <h3>Parameters</h3> <blockquote>
 * <table>
 * <tr>
 * <td><b>schema</b></td>
 ...
 * </tr>
 * </table>
 * </blockquote> <h2>set_classpath</h2> The set_classpath will define a
 * classpath for the given schema. A classpath consists of a colon separated
 * list of jar names. It's an error if the given schema does not exist or if one
 * or more jar names references non existent jars. <h3>Usage</h3> <blockquote>
 * <code>SELECT sqlj.set_classpath(&lt;schema&gt;, &lt;classpath&gt;);</code>
 * </blockquote> <h3>Parameters</h3> <blockquote>
 * <table>
 * <tr>
 * <td><b>schema</b></td>
 ...
 * </tr>
 * </table>
 * </blockquote> <h2>add_type_mapping</h2> The add_type_mapping defines the
 * mapping between an SQL type and a Java class. <h3>Usage</h3> <blockquote>
 * <code>SELECT sqlj.add_type_mapping(&lt;sqlTypeName&gt;, &lt;className&gt;);</code>
 * </blockquote> <h3>Parameters</h3> <blockquote>
 * <table>
 * <tr>
 * <td><b>sqlTypeName</b></td>
 * <td>The name of the SQL type. The name can be qualified with a schema
 * (namespace). If the schema is omitted, it will be resolved according to the
 * current setting of the search_path.</td>
 * </tr>
 * <tr>
 * <td><b>className</b></td>
 * <td>The name of the class. The class must be found in the classpath in effect
 * for the current schema</td>
 * </tr>
 * </table>
 * </blockquote> <h2>drop_type_mapping</h2> The drop_type_mapping removes the
 * mapping between an SQL type and a Java class. <h3>Usage</h3> <blockquote>
 * <code>SELECT sqlj.drop_type_mapping(&lt;sqlTypeName&gt;);</code>
 * </blockquote> <h3>Parameters</h3> <blockquote>
 * <table>
 * <tr>
 * <td><b>sqlTypeName</b></td>
...
public class Commands {
     ...
     *            schema (namespace). If the schema is omitted, it will be
     *            resolved according to the current setting of the
     *            <code>search_path</code>.
     * @param javaClassName
     *            The name of the class. The class must be found in the
     *            classpath in effect for the current schema
     * @throws SQLException
     */
     ...
     * @return The defined classpath or <code>null</code> if this schema has no
     *         classpath.
     * @throws SQLException
     */
    public static String getClassPath(String schemaName) throws SQLException {
        ...
        try {
            ...
            stmt = SQLUtils.getDefaultConnection().prepareStatement("SELECT r.jarName"
     ...
     * 
     * @param image
     *            The byte array that constitutes the jar content.
     * @param jarName
     ...
     * 
     * @param jarName
     *            The name by which the system referes this jar.
     * @param undeploy
        ...
        if (entries != null) {
            ...
            try {
                ...
                for (int idx = 0; idx < top; ++idx) {
                    int jarId = entries.get(idx).intValue();
                    stmt.setString(1, schemaName);
                    stmt.setInt(2, idx + 1);
                    stmt.setInt(3, jarId);
                    stmt.executeUpdate();
    ...
    private static SQLDeploymentDescriptor getDeploymentDescriptor(int jarId)
                                                                             throws SQLException {
        ResultSet rs = null;
        PreparedStatement stmt = SQLUtils.getDefaultConnection().prepareStatement("SELECT e.entryImage"
    ...
    private static String getFullSqlName(String sqlTypeName)
        ...
        ResultSet rs = null;
        PreparedStatement stmt = SQLUtils.getDefaultConnection().prepareStatement("SELECT n.nspname, t.typname FROM pg_type t, pg_namespace n"
    ...
    private static Oid getSchemaId(String schemaName) throws SQLException {
        ResultSet rs = null;
        PreparedStatement stmt = SQLUtils.getDefaultConnection().prepareStatement("SELECT oid FROM pg_namespace WHERE nspname = ?");
        try {
            stmt.setString(1, schemaName);
            rs = stmt.executeQuery();
            if (!rs.next()) {
    ...
    private static void replaceJar(String urlString, String jarName,
                                   boolean redeploy, byte[] image)
                                                                  throws SQLException {
        AclId[] ownerRet = new AclId[1];
        int jarId = getJarId(jarName, ownerRet);
        if (jarId < 0) {
            throw new SQLException("No Jar named '" + jarName
                                   + "' is known to the system", "4600A");
        }
